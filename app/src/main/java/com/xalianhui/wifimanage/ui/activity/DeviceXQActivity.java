...
import com.xalianhui.wifimanage.control.activity.DeviceXQControl;
import com.xalianhui.wifimanage.control.activity.SelectLoginControl;
import com.xalianhui.wifimanage.ui.BaseActivity;


public class DeviceXQActivity extends BaseActivity{

    private DeviceXQControl control;

    @Override
    protected int addLayout() {
        control = new DeviceXQControl();
