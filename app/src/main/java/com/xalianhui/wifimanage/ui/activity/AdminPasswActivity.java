...
import com.xalianhui.wifimanage.control.activity.AdminPassControl;
import com.xalianhui.wifimanage.control.activity.SetWifiControl;
import com.xalianhui.wifimanage.ui.BaseActivity;


public class AdminPasswActivity extends BaseActivity{

    private AdminPassControl control;

    @Override
    protected int addLayout() {
        control = new AdminPassControl();
        return R.layout.activity_admin_pass;
    }
