...
import com.xalianhui.wifimanage.control.activity.SetPasswordControl;
import com.xalianhui.wifimanage.ui.BaseActivity;


public class SetPasswordActivity extends BaseActivity{

    private SetPasswordControl control;

    @Override
    protected int addLayout() {
        control = new SetPasswordControl();
        return R.layout.activity_set_passwork;
    }
